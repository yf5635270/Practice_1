...
/**
 * 活动奖励（返款）明细查询接口测试类
 * com.hlpay.trade.jack.web.ActBackController.getQueryList()
 *
 * @author yzln.
...
public class ActBackQueryTest extends TradeBasicSeleniumTest {
    ...
    @Autowired
    private ActBackTest actBackTest;
     ...
     */
    @Test
    public void test_08_TradeNoEmpty() {
        SortedMap<String, Object> paramsMap = prepareReqParams();
     ...
     */
    @Test
    public void test_09_BatchNoEmpty() {
        SortedMap<String, Object> paramsMap = prepareReqParams();
        paramsMap.remove("batch_no");

        String code = getResultCode(gatewayUrl, paramsMap);
        Assert.assertEquals("113", code);
    }
     ...
     */
    @Test
    public void test_13_BackQuery() {
        LOGGER.info("testBackQuery ==>");

        actBackTest.test_13_Back();
    ...
    private SortedMap<String, Object> prepareReqParams() {
        ...
        paramsMap.put("batch_no", IdWorker.getOrderNo());
