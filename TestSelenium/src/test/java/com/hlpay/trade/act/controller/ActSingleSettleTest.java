...
/**
 * 单笔结算测试类
 * com.hlpay.trade.jack.web.ActSettlementController.singleSettlement()
 *
 * @author yzln.
...
public class ActSingleSettleTest extends TradeBasicSeleniumTest {
     ...
     */
    @Test
    public void test_13_SingleSettle() {
        LOGGER.info("testSingleSettle ==>");
    ...
    private String getArrayData() {
        ...
        batchMap.put("items", getItemArray());
    ...
    private JSONArray getItemArray() {
        ...
        securityMoney.put("title", "act-单笔结算-担保金");
        ...
        serviceMoney.put("title", "act-单笔结算-服务费");
