 ...
 * @date 2020-07-24 14:17
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class ActBackWithPwTest extends TradeBasicSeleniumTest {
    ...
    public void test_05_FromUserCodeEmpty() {
        ...
        WebElement msg = driver.findElement(By.xpath("/html/body/div[3]/div/div/div"));
        Assert.assertEquals("用户编号不能为空。", msg.getText());
    }
     ...
     */
    @Test
    public void test_13_BackWithPw() {
        LOGGER.info("testBackWithPw ==>");
