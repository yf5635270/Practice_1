...
/**
 * 活动支付查询接口测试类
 * com.hlpay.trade.jack.web.ActPayQueryController
 *
 * @author yzln.
...
public class ActPayQueryTest extends TradeBasicSeleniumTest {
    ...
    public void setUp() {
        ...
        actPayNo = redisUtils.get(CACHE_NAMESPACE_TRADE, ActCacheKey.ACT_PAY_NO);
    }
     ...
     */
    @Test
    public void test_05_PayNoEmpty() {
        SortedMap<String, Object> paramsMap = prepareReqParams();
     ...
     */
    @Test
    public void test_06_PayNoNotExist() {
        SortedMap<String, Object> paramsMap = prepareReqParams();
     ...
     */
    @Test
    public void test_10_PayQuery() {
        LOGGER.info("test_10_PayQuery ==>");
