...
/**
 * 编辑退款查询接口测试类
 * com.hlpay.trade.jack.web.ActPayQueryController.payRefundQuery()
 *
 * @author yzln.
...
public class ActPayRefundQueryTest extends TradeBasicSeleniumTest {
    ...
    public void setUp() {
        ...
        actPayNo = redisUtils.get(CACHE_NAMESPACE_TRADE, ActCacheKey.ACT_PAY_NO_FOR_PAY_REFUND);
        if (actPayNo == null) {
            actPayTest.test_19_PayRefund();
            actPayNo = redisUtils.get(CACHE_NAMESPACE_TRADE, ActCacheKey.ACT_PAY_NO_FOR_PAY_REFUND);
        }
    }
     ...
     */
    @Test
    public void test_04_RefundQuery() {
        LOGGER.info("test_04_RefundQuery ==>");
