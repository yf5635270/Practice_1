...
/**
 * 活动结算接口测试类
 * com.hlpay.trade.jack.web.ActSettlementController.settlementNoPassword()
 *
 * @author yzln.
...
public class ActSettleTest extends TradeBasicSeleniumTest {
    ...
    public void test_07_FromUserCodeIncorrect() {
        SortedMap<String, Object> paramsMap = prepareReqParams();
        paramsMap.put("from_user_code", 1L);
    ...
    public void test_13_Settle() {
        ...
        JSONObject object = jsonArray.getJSONObject(0);
        String batchCode = String.valueOf(object.get("result_code"));

        Assert.assertEquals("1", batchCode);
